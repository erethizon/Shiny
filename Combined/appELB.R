#update to substitute tree map for pie chart
...
#load csv files from Erika's laptop
all_forests <- read_csv("~/Dropbox/R/KateSyncedShiny/Combined/Data/CSVs/all_forests.csv")
dat_molten<- read_csv("~/Dropbox/R/KateSyncedShiny/Combined/Data/CSVs/dat_molten.csv")
dat_sum<- read_csv("~/Dropbox/R/KateSyncedShiny/Combined/Data/CSVs/dat_sum.csv")
...
newData<- read_csv("~/Dropbox/R/KateSyncedShiny/Combined/Data/CSVs/newData.csv")
divFinal<- read_csv("~/Dropbox/R/KateSyncedShiny/Combined/Data/CSVs/divFinal.csv")
Activity <- read_csv("~/Dropbox/R/KateSyncedShiny/Combined/Data/CSVs/Activity.csv")
...
#Map of Study Sites
 ...
 #####################################################   
    ...
    ggplot(data,(aes(area = value, label = label, fill = as.factor(variable))))+
      ...
      scale_fill_manual(values = c("Water" = "dodgerblue3",
                                  "Mixed" = "darkolivegreen4",
                                  "Evergreen" = "darkgreen",
                                  "Deciduous" = "forestgreen",
                                  "Development" = "gray",
                                  "Agriculture" = "gold3",
                                  "Barren" = "black",
                                  "Shrub" = "darkgoldenrod3",
                                  "Wetland" = "mediumseagreen",
                                  "Herbaceous" = "olivedrab3"))+
      theme(
